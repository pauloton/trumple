...
const SECOND_TERM_ARCHIVE = PRESIDENTIAL_EVENTS.filter((event) => event.date >= SECOND_TERM_START);
...
export const FEATURED_SECOND_TERM_EVENTS = Object.freeze(
  mergeLibrary(SEED_EVENTS, GENERATED_EVENTS)
);
export const EVENT_LIBRARY = Object.freeze(
  mergeLibrary(FEATURED_SECOND_TERM_EVENTS, SECOND_TERM_ARCHIVE)
);
...
export const LEGACY_EVENTS = Object.freeze(
  mergeLibrary(PRESIDENTIAL_EVENTS, [...SEED_EVENTS, ...GENERATED_EVENTS])
);
